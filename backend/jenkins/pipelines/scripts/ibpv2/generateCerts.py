...
def generatePeerSection(templateContent, peerName,componets):
    ...
    templateContent['grpcOptions']['ssl-target-name-override'] = searchfromcomponets(componets,peerName,'api_url').split(':')[0]
...
def generateOrdererSection(templateContent, ordererName,componets):
    ...
    templateContent['grpcOptions']['ssl-target-name-override'] = searchfromcomponets(componets,ordererName,'api_url').split(':')[0]
